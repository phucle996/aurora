...
type mailPricingRepoStub struct {
...
func (s mailPricingRepoStub) GetActiveMailPricingSnapshot(context.Context, entity.ChargeKindCode, time.Time) (*entity.MailPricingSnapshot, error) {

	return s.snapshot, nil
}

func (s mailPricingRepoStub) GetActiveMailZonePriceAdjustment(context.Context, uuid.UUID, time.Time) (*entity.MailZoneAdjustmentSnapshot, error) {
	return s.adjustment, nil
}

func (s mailPricingRepoStub) CreateMailZonePriceAdjustment(_ context.Context, command entity.MailZoneAdjustmentPublishCommand) (*entity.MailZoneAdjustmentPublished, error) {
...
func TestMailEstimateAppliesMailZoneAdjustmentToAcceptedRecipients(t *testing.T) {
	...
	adjustmentService := service.NewMailPricingService(mailPricingRepoStub{}, nil)
	...
	brackets := []entity.MailPricingSnapshotBracket{{RangeStartQuantity: 0, PriceNumeratorMicroUnits: 5, PriceDenominatorQuantity: 1_000}}
	hash := sha256.New()
	...
	estimateService := service.NewMailPricingService(mailPricingRepoStub{snapshot: &entity.MailPricingSnapshot{
