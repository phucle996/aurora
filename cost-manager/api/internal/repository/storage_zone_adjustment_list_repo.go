...
type storageZoneAdjustmentListRepository struct{ db *pgxpool.Pool }

func NewStorageZoneAdjustmentListRepository(db *pgxpool.Pool) *storageZoneAdjustmentListRepository {
	return &storageZoneAdjustmentListRepository{db: db}
}

func (r *storageZoneAdjustmentListRepository) ListStorageZonePriceAdjustments(ctx context.Context, query entity.StorageZoneAdjustmentListQuery) ([]entity.StorageZoneAdjustmentListItem, bool, error) {
