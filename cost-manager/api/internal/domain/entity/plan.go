...
// Danh sách các Service Type được hỗ trợ
const (
	ServiceTypeStorage = "STORAGE" // Dịch vụ lưu trữ
	ServiceTypeVM      = "VM"      // Dịch vụ máy chủ ảo
	ServiceTypeMail    = "MAIL"    // Dịch vụ thư điện tử
)
...
type Plan struct {
	...
	ServiceType  string    // Loại dịch vụ (STORAGE | VM | MAIL)
