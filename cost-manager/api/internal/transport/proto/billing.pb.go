...
const file_proto_billing_proto_rawDesc = "" +
	"\n" +
	"\x13proto/billing.proto\x12\fbillingproto\"O\n" +
	...
	"\x0foverdraft_limit\x18\x04 \x01(\x01R\x0eoverdraftLimit2l\n" +
	"\x0eBillingService\x12Z\n" +
	"\x11CheckWalletStatus\x12!.billingproto.WalletStatusRequest\x1a\".billingproto.WalletStatusResponseB%Z#cost-manager/api/proto/billingprotob\x06proto3"
...
var file_proto_billing_proto_goTypes = []any{
	(*WalletStatusRequest)(nil),  // 0: billingproto.WalletStatusRequest
	(*WalletStatusResponse)(nil), // 1: billingproto.WalletStatusResponse
}
var file_proto_billing_proto_depIdxs = []int32{
	0, // 0: billingproto.BillingService.CheckWalletStatus:input_type -> billingproto.WalletStatusRequest
	1, // 1: billingproto.BillingService.CheckWalletStatus:output_type -> billingproto.WalletStatusResponse
