...
DROP INDEX IF EXISTS billing.idx_mail_accepted_usage_pending;
DROP INDEX IF EXISTS billing.idx_hypervisor_network_line_pending;
DROP INDEX IF EXISTS billing.idx_hypervisor_network_report_pending;
DROP INDEX IF EXISTS billing.idx_hypervisor_allocation_line_pending;
DROP INDEX IF EXISTS billing.idx_hypervisor_allocation_window_claim;
DROP INDEX IF EXISTS billing.idx_hypervisor_allocation_interval_window;
