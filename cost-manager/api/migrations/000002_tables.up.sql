...
-- 26. Storage usage report settlement inbox. The report payload is bounded by
-- the producer/consumer contract and retained for replay/audit, not as a
...
CREATE TABLE IF NOT EXISTS billing.storage_usage_line_inbox (
    ...
    usage_quantity      BIGINT NOT NULL,
    usage_unit          VARCHAR(24) NOT NULL DEFAULT 'BYTE',
