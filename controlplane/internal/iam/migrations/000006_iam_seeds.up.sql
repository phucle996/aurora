...
VALUES
    ...
    -- [COMMENT]: Permissions cho Hypervisor (VM & Image catalog)
    ...
    -- [COMMENT]: Customer catalog and instance operations remain scoped by
    -- trusted workspace/Zone context; write is admitted only after P07 settlement.
    (gen_random_uuid(), 'managed-service', 'catalog', 'read', 'Read provisionable managed service catalog'),
    (gen_random_uuid(), 'managed-service', 'instance', 'read', 'Read managed service instances and operations'),
    (gen_random_uuid(), 'managed-service', 'instance', 'write', 'Create and operate managed service instances')
...
-- [COMMENT]: Personal users control their own workspace. Tenant mutation is
-- limited to operator roles; tenant_member/viewer remain read-only.
INSERT INTO role_permissions (role_id, permission_id)
SELECT r.id, p.id
FROM roles r
CROSS JOIN permissions p
WHERE r.code IN ('platform_user', 'tenant_owner', 'tenant_admin', 'tenant_manager')
  AND p.module = 'managed-service'
  AND p.object = 'instance'
  AND p.behavior = 'write'
ON CONFLICT (role_id, permission_id) DO NOTHING;

-- [COMMENT]: Every customer role may read catalog and instance projections
-- admitted by the existing five-level workspace authorization. PostgreSQL
-- still binds the selected personal/tenant workspace to the trusted Zone.
INSERT INTO role_permissions (role_id, permission_id)
SELECT r.id, p.id
FROM roles r
CROSS JOIN permissions p
WHERE r.code IN ('platform_user', 'tenant_owner', 'tenant_admin', 'tenant_manager', 'tenant_member', 'tenant_viewer')
  AND p.module = 'managed-service'
  AND p.object IN ('catalog', 'instance')
  AND p.behavior = 'read'
ON CONFLICT (role_id, permission_id) DO NOTHING;
...
-- [COMMENT]: Hypervisor permissions cho platform_user
INSERT INTO role_permissions (role_id, permission_id)
SELECT r.id, p.id
FROM roles r
CROSS JOIN permissions p
WHERE r.code = 'platform_user'
  AND p.module = 'hypervisor'
  AND (
    (p.object = 'vm' AND p.behavior IN ('read', 'create')) OR
    (p.object = 'image' AND p.behavior = 'read')
  )
ON CONFLICT (role_id, permission_id) DO NOTHING;
...
SELECT 
    ...
    r.name,
    r.role_level,
    decode('', 'hex')
FROM users u
CROSS JOIN roles r
...
SELECT 
    ...
    r.name,
    r.role_level,
    decode('', 'hex')
    || decode('0a297379735f61646d696e3a2a3a6d616e616765642d736572766963653a696e7374616e63653a726561640a2a7379735f61646d696e3a2a3a6d616e616765642d736572766963653a696e7374616e63653a7772697465', 'hex')
FROM users u
CROSS JOIN roles r
...
SELECT 
    ...
    r.name,
    r.role_level,
    decode('', 'hex')
    || decode('0a30737570706f72745f6f70657261746f723a2a3a6d616e616765642d736572766963653a696e7374616e63653a72656164', 'hex')
FROM users u
CROSS JOIN roles r
...
SELECT 
    ...
    r.name,
    r.role_level,
    decode('', 'hex')
    || decode('0a2c61756469745f7669657765723a2a3a6d616e616765642d736572766963653a696e7374616e63653a72656164', 'hex')
FROM users u
CROSS JOIN roles r
