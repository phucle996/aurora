...
DROP INDEX IF EXISTS idx_billing_outbox_published_cleanup;
DROP INDEX IF EXISTS idx_billing_outbox_owner_audit;
DROP INDEX IF EXISTS idx_billing_outbox_claim;
