...
func (c *sessionServiceClient) RevokeUserSessionsByDevices(ctx context.Context, in *RevokeUserSessionsByDevicesRequest, opts ...grpc.CallOption) (*RevokeUserSessionsByDevicesResponse, error) {
	...
	out := new(RevokeUserSessionsByDevicesResponse)
	err := c.cc.Invoke(ctx, SessionService_RevokeUserSessionsByDevices_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SessionService_RevokeUserSessionsByDevices_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RevokeUserSessionsByDevicesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SessionServiceServer).RevokeUserSessionsByDevices(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SessionService_RevokeUserSessionsByDevices_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SessionServiceServer).RevokeUserSessionsByDevices(ctx, req.(*RevokeUserSessionsByDevicesRequest))
	}
...
var SessionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "iam.rpc.SessionService",
