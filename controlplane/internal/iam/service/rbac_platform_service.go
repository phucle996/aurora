...
func (s *RbacPlatformService) AssignUserRole(ctx context.Context, callerLevel uint8, userID uuid.UUID, roleID uuid.UUID) (err error) {
	startedAt := time.Now()
	defer func() {
...
func (s *RbacPlatformService) CreateRole(ctx context.Context, callerUserID uuid.UUID, role *iamEntity.Role, permissionIDs []uuid.UUID) (err error) {
	startedAt := time.Now()
	defer func() {
		result, reason := observability.ResultFailure, observability.ReasonInternal
		switch {
...
func (s *RbacPlatformService) ListPermissions(ctx context.Context, callerUserID uuid.UUID) (out []iamEntity.Permission, err error) {
	startedAt := time.Now()
	defer func() {
		result, reason := observability.ResultFailure, observability.ReasonInternal
		if err == nil {
...
func (s *RbacPlatformService) GetUserRoleDetails(ctx context.Context, userID uuid.UUID, callerLevel int32) (out *iamEntity.Role, err error) {
	startedAt := time.Now()
	defer func() {
		result, reason := observability.ResultFailure, observability.ReasonInternal
		if err == nil {
...
func (s *RbacPlatformService) GetUserRolePermissions(ctx context.Context, userID uuid.UUID) (out []byte, err error) {
	startedAt := time.Now()
	defer func() {
		result, reason := observability.ResultFailure, observability.ReasonInternal
		if err == nil {
...
func (s *RbacPlatformService) GetRoleDetails(ctx context.Context, callerLevel uint8, roleID uuid.UUID) (role *iamEntity.Role, permissions []iamEntity.Permission, err error) {
	startedAt := time.Now()
	defer func() {
		result, reason := observability.ResultFailure, observability.ReasonInternal
		if err == nil {
...
func (s *RbacPlatformService) UpdateRole(ctx context.Context, callerUserID uuid.UUID, callerLevel uint8, input *iamEntity.UpdateRoleInput) (err error) {
	startedAt := time.Now()
	defer func() {
		result, reason := observability.ResultFailure, observability.ReasonInternal
		switch {
