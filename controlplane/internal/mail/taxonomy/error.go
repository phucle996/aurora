...
var (
	...
	ErrInvalidCommercialAdmissionProjection = errors.New("mail: invalid commercial admission projection")
	ErrCommercialAdmissionUnavailable       = errors.New("mail: commercial admission unavailable")
	ErrPricingUnavailable                   = errors.New("mail: pricing unavailable")
