...
type ZoneServiceClient interface {
	...
	ResolveZone(ctx context.Context, in *ResolveZoneRequest, opts ...grpc.CallOption) (*ResolveZoneResponse, error)
}
...
func (c *zoneServiceClient) ResolveZone(ctx context.Context, in *ResolveZoneRequest, opts ...grpc.CallOption) (*ResolveZoneResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ResolveZoneResponse)
	err := c.cc.Invoke(ctx, ZoneService_ResolveZone_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ZoneServiceServer interface {
	...
	ResolveZone(context.Context, *ResolveZoneRequest) (*ResolveZoneResponse, error)
...
func (UnimplementedZoneServiceServer) ResolveZone(context.Context, *ResolveZoneRequest) (*ResolveZoneResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ResolveZone not implemented")
}
...
func _ZoneService_ResolveZone_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ResolveZoneRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ZoneServiceServer).ResolveZone(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ZoneService_ResolveZone_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ZoneServiceServer).ResolveZone(ctx, req.(*ResolveZoneRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ZoneService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ResolveZone",
			Handler:    _ZoneService_ResolveZone_Handler,
		},
	},
