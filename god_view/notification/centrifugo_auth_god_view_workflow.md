...
- **OTel Metrics**: Auth call dùng `notification_shared_redis_calls_total` và `notification_shared_redis_call_duration_seconds`; NATS metrics chỉ dành cho realtime event listener.
